...
async def test_swagger_routes_available_under_api_prefix(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert "/api/providers/kalshi/markets" in body["paths"]
    assert "/api/providers/kalshi/markets/{ticker}" in body["paths"]
    assert "/api/providers/kalshi/markets/{ticker}/orderbook" in body["paths"]
    assert "/api/providers/kalshi/balance" in body["paths"]
    assert "/api/providers/kalshi/positions" in body["paths"]
    assert "/api/providers/kalshi/orders" in body["paths"]
    assert "/api/providers/kalshi/orders/{order_id}" in body["paths"]
    assert "/api/providers/kalshi/orders/{order_id}/amend" in body["paths"]
    assert "/api/providers/kalshi/orders/{order_id}/queue-position" in body["paths"]
    assert "/api/providers/kalshi/orders/queue-positions" in body["paths"]
    assert "/api/providers/kalshi/account/limits" in body["paths"]
