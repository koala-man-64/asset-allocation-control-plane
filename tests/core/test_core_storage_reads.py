...
from asset_allocation_runtime_common.shared_core import core
...
def test_read_raw_bytes_warns_on_missing_blob_by_default() -> None:
    ...
    with patch.object(core.logger, "warning") as mock_warning, patch.object(core.logger, "info") as mock_info:
