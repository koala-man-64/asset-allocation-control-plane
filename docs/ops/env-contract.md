...
4. Run `powershell -ExecutionPolicy Bypass -File scripts/repo/sync-all-to-github.ps1`.

Rules:

- `scripts/dev/setup-env.ps1` only walks keys documented in `env-contract.csv`.
